...
/**
 * This enum contains all common http response codes from <a href=
 * "https://developer.mozilla.org/en-US/docs/Web/HTTP/Status">https://developer.mozilla.org/en-US/docs/Web/HTTP/Status</a>.<br>
 * <br>
 * <br>
 * Documentation taken directly from <a href=
...
public enum HTTPResponseCode {
	 ...
	 * method:
	 * <ul>
	 * <li>GET: The resource has been fetched and transmitted in the message
	 * body.</li>
	 * <li>HEAD: The representation headers are included in the response without any
	 * message body.</li>
	 * <li>PUT or POST: The resource describing the result of the action is
	 * transmitted in the message body.</li>
	 * <li>TRACE: The message body contains the request message as received by the
	 * server.</li>
	 * </ul>
	 */
	OK(200),
	...
	/**
	 * Try to get the {@link HTTPResponseCode} by the corresponding http response
	 * code number
	 * 
	 * @param code The code to try to get
	 * @return The corresponding {@link HTTPResponseCode} or <code>null</code> if
	 *         its not implemented in this enum
	 */
